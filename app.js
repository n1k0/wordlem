...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{r: _List_Nil, w: '', B: $elm$core$Maybe$Nothing, I: $author$project$Main$Ongoing, H: $elm$core$Maybe$Nothing},
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								I: $author$project$Main$Errored('There was an issue while picking a word')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 3:

...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Store$Store = F3(function(lang, logs, helpViewed) {
        return {
    ...
    var $author$project$Main$initialModel = function(store) {
        return {
            ...
            state: $author$project$Main$Idle,
            store: store,
        ...
        var _v0 = function() {
            ...
            if (_v1.$ === 'Ok') {
                ...
                return _Utils_Tuple2(_Utils_update(newModel, {
                    state: $author$project$Main$Errored($author$project$Main$DecodeError($elm$json$Json$Decode$errorToString(error)))
    ...
    var $author$project$Main$LoadError = {
        $: 'LoadError'
    };
    var $author$project$Main$Ongoing = F3(function(a, b, c) {
        return {
            $: 'Ongoing',
            a: a,
            b: b,
    ...
    var $author$project$Main$Lost = F2(function(a, b) {
        return {
            $: 'Lost',
            a: a,
            b: b
    ...
    var $author$project$Main$Won = F2(function(a, b) {
        return {
            $: 'Won',
            a: a,
            b: b
    ...
    var $author$project$Main$checkGame = F2(function(word, guesses) {
        return $author$project$Main$hasWon(guesses) ? A2($author$project$Main$Won, word, guesses) : _Utils_cmp($elm$core$List$length(guesses), $author$project$Main$maxAttempts) > -1 ? A2($author$project$Main$Lost, word, guesses) : A3($author$project$Main$Ongoing, word, guesses, '');
    });
    ...
    var $author$project$Main$letterIs = F2(function(build, _char) {
        return $elm$core$Basics$eq(build(_char));
    });
    var $author$project$Main$handleCorrectDuplicates = F2(function(wordChars, guess) {
        return A2($elm$core$List$map, function(letter) {
            if (letter.$ === 'Misplaced') {
                var c = letter.a;
                var _v1 = _Utils_Tuple2($elm$core$List$length(A2($elm$core$List$filter, $elm$core$Basics$eq(c), wordChars)), $elm$core$List$length(A2($elm$core$List$filter, A2($author$project$Main$letterIs, $author$project$Main$Correct, c), guess)));
    ...
    var $author$project$Main$handleMisplacedDuplicates = function(wordChars) {
        return A2($elm$core$List$foldl, F2(function(letter, acc) {
            if (letter.$ === 'Misplaced') {
                var c = letter.a;
                var _v1 = _Utils_Tuple2($elm$core$List$length(A2($elm$core$List$filter, $elm$core$Basics$eq(c), wordChars)), $elm$core$List$length(A2($elm$core$List$filter, A2($author$project$Main$letterIs, $author$project$Main$Misplaced, c), acc)));
    ...
    var $author$project$Main$mapChars = F3(function(wordChars, inputChar, wordChar) {
    ...
    var $author$project$Main$validateGuess = F3(function(lang, word, input) {
        ...
        return !_Utils_eq($elm$core$List$length(inputChars), $author$project$Main$numberOfLetters) ? $elm$core$Result$Err(A2($author$project$I18n$translate, lang, $author$project$I18n$NotEnoughLetters)) : !A2($elm$core$List$member, normalize(input), $author$project$Main$getWords(lang)) ? $elm$core$Result$Err(A2($author$project$I18n$translate, lang, $author$project$I18n$AbsentFromDictionary({
            lang: lang,
            word: input
        }))) : $elm$core$Result$Ok(A2($author$project$Main$handleMisplacedDuplicates, wordChars, A2($author$project$Main$handleCorrectDuplicates, wordChars, A3($elm$core$List$map2, $author$project$Main$mapChars(wordChars), inputChars, wordChars))));
    });
        ...
        _v0$9: while(true)switch(_v0.a.$){
            case 'BackSpace':
                if (_v0.b.$ === 'Ongoing') {
                    ...
                    var input = _v2.c;
                    return _Utils_Tuple2(_Utils_update(model, {
                        state: A3($author$project$Main$Ongoing, word, guesses, A2($elm$core$String$dropRight, 1, input))
                    }), $elm$core$Platform$Cmd$none);
                } else {
                    var _v3 = _v0.a;
            ...
            case 'KeyPressed':
                if (_v0.b.$ === 'Ongoing') {
                    ...
                    var input = _v5.c;
                    return _Utils_Tuple2(_Utils_update(model, {
                        state: A3($author$project$Main$Ongoing, word, guesses, A2($author$project$Main$addChar, _char, input))
            ...
            case 'NewWord':
                if (_v0.a.a.$ === 'Just') {
                    if (_v0.b.$ === 'Idle') {
                        ...
                        var _v7 = _v0.b;
                        return _Utils_Tuple2(_Utils_update(model, {
                            state: A3($author$project$Main$Ongoing, newWord, _List_Nil, '')
                        }), $author$project$Main$defocusMenuButtons);
                    } else break _v0$9;
                } else {
                    if (_v0.b.$ === 'Idle') {
                        ...
                        var _v9 = _v0.b;
                        return _Utils_Tuple2(_Utils_update(model, {
                            state: $author$project$Main$Errored($author$project$Main$LoadError)
                        }), $elm$core$Platform$Cmd$none);
                    } else break _v0$9;
                }
            case 'NoOp':
            ...
            case 'Submit':
                if (_v0.b.$ === 'Ongoing') {
                    ...
                    var guesses = _v12.b;
                    var input = _v12.c;
                    var _v13 = A3($author$project$Main$validateGuess, store.lang, word, input);
                    if (_v13.$ === 'Ok') {
                        var guess = _v13.a;
                        return $author$project$Main$logResult($author$project$Main$processStateNotif(_Utils_Tuple2(_Utils_update(model, {
                            state: A2($author$project$Main$checkGame, word, A2($elm$core$List$cons, guess, guesses))
                        }), $author$project$Main$scrollToBottom('board-container'))));
                    } else {
                        var error = _v13.a;
                        return A3($author$project$Notif$add, $author$project$Main$ToastyMsg, $author$project$Notif$Warning(error), _Utils_Tuple2(_Utils_update(model, {
                            state: A3($author$project$Main$Ongoing, word, guesses, input)
                        }), $elm$core$Platform$Cmd$none));
                    }
                } else {
                    var _v14 = _v0.a;
    ...
    var $author$project$Main$viewHelp = function(_v0) {
        ...
        var demo = _List_fromArray([
            $author$project$Main$Correct(_Utils_chr('m')),
            $author$project$Main$Misplaced(_Utils_chr('e')),
            $author$project$Main$Unused(_Utils_chr('t')),
            $author$project$Main$Correct(_Utils_chr('a')),
            $author$project$Main$Unused(_Utils_chr('s'))
        ]);
    ...
    var $author$project$Main$viewBoardElement = $elm$html$Html$div(_List_fromArray([
    ...
    var $author$project$Main$viewBoard = F2(function(input, guesses) {
        ...
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            $author$project$Main$viewBoardElement(A2($elm$core$List$filterMap, $elm$core$Basics$identity, $elm$core$List$concat(_List_fromArray([
    ...
    var $author$project$Main$dispositions = function(lang) {
        return A2($elm$core$List$map, $elm$core$String$toList, function() {
            if (lang.$ === 'French') return _List_fromArray([
                'azertyuiop',
                'qsdfghjklm',
                '⏎wxcvbn⌫'
            ]);
    ...
    var $author$project$Main$viewKeyboard = F2(function(lang, guesses) {
        ...
        ])), $elm$core$List$map(A2($elm$core$Basics$composeR, $author$project$Main$keyState(guesses), $author$project$Main$viewKeyState))), $author$project$Main$dispositions(lang)));
    });
            ...
            switch(state.$){
                ...
                case 'Won':
                    ...
                    return _List_fromArray([
                        ...
                        A2($author$project$Main$viewKeyboard, store.lang, guesses)
                    ]);
                case 'Lost':
                    var word = state.a;
                    var guesses = state.b;
                    return _List_fromArray([
                        ...
                        }(A2($elm$core$List$map, $author$project$Main$Correct, $elm$core$String$toList(word)))),
                        A2($author$project$Main$endGameButtons, store.lang, word),
                        A2($author$project$Main$viewKeyboard, store.lang, guesses)
                    ]);
                default:
